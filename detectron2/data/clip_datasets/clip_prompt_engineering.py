...
def get_prompt_templates():
    ...
    prompt_templates = [
        ...
        "A moving {} near a traffic light.",
        "A {} crossing a pedestrian crosswalk.",
        "A waiting {} at the intersection.",
        "A {} parked near a sidewalk.",
        "A walking {} on the zebra crossing.",
        "A static {} beside the highway ramp.",
        "A moving {} on the main road.",
        "A stopped {} near the road divider.",
        "A {} riding on the bicycle lane.",
        "A standing {} on the corner of the street.",
        "A {} near a school zone.",
        "A {} mounted on a lamp post.",
        "A blinking {} at a T-junction.",
        "A {} approaching the bus stop.",
        "A {} placed on the curbside.",
        "A stopped {} in the middle of the intersection.",
        "A moving {} on the urban road.",
        "A {} in front of a crosswalk.",
        "A {} observing a crowded crossing.",
    ]
